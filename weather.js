...
function radar() {
	$('#map').append('<div id="legend"><span id="labelTop"><p id="light">Light</p><p id="heavy">Heavy</p></span><img src="rain-legend.png" alt="rain scale" id="rain"></img><img src="snow-legend.png" alt="snow scale" id="snow"></img></div>')
	let lonLat = [lon,lat];
	var map = new ol.Map({
    target: 'map',
    layers: [
